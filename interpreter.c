...
static const char  *alias_prefixes[] = {    "but",  "within",   "notwithin",   "around",    "notaround"};
static const TokenType alias_types[] = {TK_NOT_OP, TK_ADJ_OP, TK_NOT_ADJ_OP, TK_NEAR_OP, TK_NOT_NEAR_OP};
